...
export const Navbar = (props) => {
  return (
      <div className={` w-full h-[12rem] lg:fixed overflow-hidden bg-transparent lg:border-none lg:h-full lg:w-[17rem] top-0 z-50 lg:overflow-y-auto scrollbar-hide duration-500`}>
