...
import { HiOutlineLightBulb, HiMenuAlt2 } from "react-icons/hi";
...
export const Navbar = (props) => {
  ...
  return (
    <>
      {/* Mobile top bar */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-2.5 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-md border-b border-neutral-200 dark:border-neutral-700">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm font-semibold text-neutral-800 dark:text-neutral-200">{props.name}</span>
        </div>
        <DarkModeToggle />
      </div>
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="lg:hidden fixed top-0 left-0 bottom-0 z-[61] w-72 max-w-[80vw] bg-white dark:bg-neutral-900 shadow-2xl overflow-y-auto"
            >
              <div className="flex items-center justify-between p-4 border-b border-neutral-200 dark:border-neutral-700">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-neutral-500">{props.nick}</p>
                  </div>
                </div>
                <button
                  onClick={() => setOpen(false)}
      ...
      {/* Desktop sidebar */}
      <div className="hidden lg:block lg:fixed lg:mt-2 lg:h-full lg:w-[17rem] top-0 z-50 overflow-y-auto scrollbar-hide">
