    ...
    (<motion.div
      ...
      <motion.div
        ...
        <p className="text-xs text-neutral-500">
          There are many things that can be used as a business out there with your website ....
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
        className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center justify-end space-x-2 w-3/4 ml-auto bg-white dark:bg-black">
        <p className="text-xs text-neutral-500">L et's Do it</p>
        <div
          className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    </motion.div>)
...
const items = [
  {
    ...
    description: (
      <span className="text-sm">
        Showing you portfolio data to others with different experience.
      </span>
    ),
    header: <SkeletonOne />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Let me make your documents more easy to access
      </span>
    ),
    header: <SkeletonTwo />,
    className: "md:col-span-1",
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Create what do you want, website design!!
      </span>
    ),
  ...
  {
    title: "Draw & Graphic Design",
    description: (
      <span className="text-sm">
        More design to complement your needs
      </span>
    ),
    header: <SkeletonFour />,
...

  {
    ...
    description: (
      <span className="text-sm">
        Let get your website into the business realm
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-1",
